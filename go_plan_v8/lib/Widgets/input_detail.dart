...
class MyInputDetail extends StatelessWidget {
  ...
  const MyInputDetail({Key? key, required this.title, required this.hint, this.controller, this.widget}) : super(key: key);
