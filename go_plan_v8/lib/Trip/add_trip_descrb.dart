...
class AddTripDes extends StatefulWidget {
  final String tripId;
  ...
  @override
  State<AddTripDes> createState() => _AddTripDesState();
}

class _AddTripDesState extends State<AddTripDes> {
  bool? isPublic;
  String? tripIds;
  String? tripTitles;
  int? dateRanges;
  ...
  _appBar (bool? isPublic) {
    ...
    return AppBar(
      ...
      leading: IconButton(
                ...
                builder: (context) => Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20,),
                          Text("ใครสามารถเห็นทริปนี้ได้บ้าง ?",style: TextStyle(fontFamily: 'Kanit'
                          , color:  Colors.black,fontSize: 20),),
                          TextButton(
                              onPressed: () {
                                setState(() {
                                  getMyData();
                                  FirebaseFirestore.instance.collection("trips").doc(trip).update({
                                  'isPublic': true,
                                });
                                  isPublic = true;
                                });
          ...
          icon: Icon(isPublic == true ? 
          Icons.public : Icons.lock,color: Colors.black,),
          ),
      actions: [
        Padding(
