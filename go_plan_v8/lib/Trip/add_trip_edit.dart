...
class AddTripEdit extends StatefulWidget {
  final String tripIdEdit;
  ...
  @override
  State<AddTripEdit> createState() => _AddTripEditState();
}

class _AddTripEditState extends State<AddTripEdit> {
  final TextEditingController _tripTopicController =
      TextEditingController(text: tripNameEdit);
  final TextEditingController _startDateController =
      TextEditingController(text: startDateEdit);
  ...
  DateTimeRange dateRange =
      DateTimeRange(start: DateTime(int.parse(splitted1[2]), int.parse(splitted1[1]), int.parse(splitted1[0])), end: DateTime(int.parse(splitted2[2]), int.parse(splitted2[1]), int.parse(splitted2[0])));
  File? imageFile;
  ...
  Future<void> _uploadTask() async {
    ...
    if (isValid) {
      if (imageFile == null) {
        print(tripImageEdit.toString());
        print("no");
      } else {
        print("yes");
      }

      if (_startDateController.text == startDateEdit)
        print("status : --> valid");
